        ...
        ((props) => (
          <Div style={props} className={styles.user_description_container}>
            <div className={styles.user_description}>
              Hi, <br />I am <b className={styles.name}>Divyanshu Pandey</b>, A
              Frontend Developer with 2+ years of experience on React,
              Passionate to build Polished, Innovative, well-detailed,
              responsive and Progressive Web Apps with Fluid Animations to
            ...
            <Div row justify align className={styles.user_button_container}>
              You can download this portfolio as a{" "}
              <b className={styles.name}>Progressive Web Application</b>.
            </Div>
