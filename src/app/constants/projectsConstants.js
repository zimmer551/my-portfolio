...
import cctIcon from "Icons/project-icon-connected_Clinical_Trials.png";
import myProject_1_Icon from "Icons/project-icon-myProject_1.png";
import myProject_2_Icon from "Icons/project-icon-myProject_2.png";
import myProject_3_Icon from "Icons/project-icon-myProject_3.png";
import myProject_4_Icon from "Icons/project-icon-myProject_4.png";
import myProject_5_Icon from "Icons/project-icon-myProject_5.png";
import myProject_6_Icon from "Icons/project-icon-myProject_6.png";
import microcontrollers_Icon from "Icons/project-icon-microcontrollers.png";

export const projectsListValue = {
  CCT: {
    name: "Connected Clinical Trials",
    ...
    description: [
      ...
      },
      {
        type: "text",
        highlight: "green",
        value: "This Project has won more than 6 awards globally.",
      },
      {
        type: "header",
      ...
      },
      {
        type: "text",
        value:
          "In CCT, I worked on implementing new functionalities and modules, optimization of existing pages by reducing latency and fixing bugs.<br/>Have Architectured and implemented the documentation portal for the project as well.",
      },
      {
        type: "points",
  ...
  myProject_1: {
    ...
    tech: ["react", "redux", "javascript"],
    involvement: "Major",
    icon: myProject_1_Icon,
    description: [
      {
        type: "text",
        highlight: "green",
        value:
          "lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsumlorem ipsum lorem ipsum lorem ipsumlorem ipsum lorem ipsumlorem ipsumlorem ipsum lorem ipsumlorem ipsum lorem ipsum lorem ipsumlorem ipsumlorem ipsum",
      },
      {
        type: "text",
        highlight: "green",
  ...
  microcontrollers: {
    name: "IOT Projects",
    tech: ["microcontrollers", "IOT", "embedded C"],
    involvement: "Major",
    icon: microcontrollers_Icon,
    description: [
      {
        type: "text",
        highlight: "green",
        value: "I worked on many projects related to microcontrolles and IOT.",
      },
      {
        type: "points",
        title: "Some of the projects that I have worked upon are -",
        value: [
          "Power transformer protection using microcontrollers.",
          "Home automation system",
          "Safe lock using fingerprint sensors",
          "Automatic irrigation system",
          "Bluetooth controlled vehicle",
          "Personalised microcontroller board",
        ],
      },
    ],
  },
